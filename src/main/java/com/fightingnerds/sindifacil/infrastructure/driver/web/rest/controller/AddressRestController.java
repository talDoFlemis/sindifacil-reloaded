...
public class AddressRestController {
	...
	@PostMapping
	public ResponseEntity<CreateAddressResponse> createAddress(@RequestBody @Valid final CreateAddressRequest createAddressRequest) {
	...
	@GetMapping("/{id}")
	public ResponseEntity<CreateAddressResponse> getAddress(@PathVariable final Long id) {
	...
	@PutMapping("/{id}")
	public ResponseEntity<CreateAddressResponse> updateAddress(@PathVariable final Long id, @RequestBody @Valid final CreateAddressRequest createAddressRequest) {
		Address address = this.addressRestMapper.toDomain(createAddressRequest);
		address.setId(id);
